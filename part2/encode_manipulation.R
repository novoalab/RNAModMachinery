...
# input is mm65.long.gene.with.expr.cshl.tsv is the file downloaded from Encode
...
write.table(data3,file="encode_TPM.tsv",quote=FALSE, sep="\t")
...
write.table(data3,file="encode_TPM_renamed.tsv",quote=FALSE, sep="\t")
#####Second variable here
args <- commandArgs(trailingOnly = TRUE)
input2 <- args[2] #2nd variable mouse_id_symbol_class.tsv
